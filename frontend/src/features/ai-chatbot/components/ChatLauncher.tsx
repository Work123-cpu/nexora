      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed z-40 h-[560px] max-h-[calc(100vh-7rem)] w-[460px] max-w-[calc(100vw-2.5rem)] overflow-hidden rounded-2xl border border-border bg-surface card-shadow-lg"
          >
