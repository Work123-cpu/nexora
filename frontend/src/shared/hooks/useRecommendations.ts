...
/** Fetches this company's real inventory/materials/vendors/live-market-data and feeds the pure recommendation engine. */
function useRecommendationInputs() {
  ...
  const inputs = useMemo(
    ...
    [inventoryData, materialsData, vendorsData, marketSignals],
  )

  return { inputs, isLoading: loadingInventory || loadingMaterials || loadingVendors }
}
